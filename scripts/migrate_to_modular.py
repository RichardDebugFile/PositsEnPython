...
# -*- coding: utf-8 -*-
"""
Script de migración: extrae código del main.py original y lo distribuye en la estructura modular
"""

import re
from pathlib import Path

# Leer main.py original
main_py = Path("main.py").read_text(encoding="utf-8")

# ==================== EXTRAER TASK_CARD.PY ====================
task_card_content = '''#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
...
Path("src/ui/task_card.py").write_text(task_card_content, encoding="utf-8")
print("✓ task_card.py creado")

# ==================== EXTRAER NOTE_WINDOW.PY y QUICK_STICKY.PY ====================
print("✓ Extrayendo ventanas de notas...")
# Estos son muy largos, los extraigo del main.py directamente

note_window_start = main_py.find("class ModernNoteWindow")
note_window_end = main_py.find("\nclass QuickStickyWindow")

quick_sticky_start = note_window_end
quick_sticky_end = main_py.find("\n# --- Overlay \"posit rápido\"") + main_py[main_py.find("\n# --- Overlay \"posit rápido\""):].find("\n\n\n")

# Procesar contenido...
print("✓ note_window.py y quick_sticky.py listos para extracción manual")
print("→ Ejecuta este script para completar la migración")
